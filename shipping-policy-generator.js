jQuery(document).ready(function () {
    ...
    let doneBtn = jQuery('#shipping_policy_generator #done_btn')
    let copy = jQuery('#shipping_policy_generator #copy_btn')
    let generateBtn = jQuery('#shipping_policy_generator #btn_shipping_form')
    ...
    generateBtn.on('click', function() {
        jQuery('#shipping_policy_generator #shipping_policy_generator_form_container').removeClass('d-none')
    ...
    doneBtn.on('click', function () {
        jQuery('#shipping_policy_generator #result').removeClass('d-none').siblings().addClass('d-none')
        generate_shipping_policy(data_answer)
    })
    ...
    function toggle_nav_current(currentStep) {
        ...
        jQuery(`a[data-nav="${dataNav}"`).addClass('bg-white text-primary').siblings().removeClass('bg-white text-primary')
    }
    ...
    jQuery('#shipping_policy_generator .form-check').each(function () {
        jQuery(this).find('input[type="radio"]').on('click', function () {
            ...
            if (jQuery(this).parent().hasClass('form-others')) {
                ...
                data_answer = {
                    ...data_answer,
                    [name]: jQuery(this).parent().find(jQuery('#shipping_policy_generator .form-group')).find(jQuery('input[type="text"]')).val(),
                }

                jQuery(this).parent().find(jQuery('#shipping_policy_generator .form-group')).find(jQuery('input[type="text"]')).on('keyup', function (e) {
                    data_answer = {
                        ...data_answer,
                        [name]: e.target.value,
                    }
                })
            } else if (jQuery(this).parent().hasClass('form-textarea')) {
                jQuery(this).parent().find(jQuery('#shipping_policy_generator .form-group')).removeClass('d-none')

                data_answer = {
                    ...data_answer,
                    [name]: jQuery(this).parent().find(jQuery('#shipping_policy_generator .form-group')).find(jQuery('textarea')).val(),
                }

                jQuery(this).parent().find(jQuery('#shipping_policy_generator .form-group')).find(jQuery('textarea')).on('keyup', function (e) {
                    data_answer = {
                        ...data_answer,
                        [name]: e.target.value,
                    }
    ...
    jQuery('input[name="website_url"').on('keyup', function (e) {
        let name = jQuery(this).attr('name')
        data_answer = {
            ...data_answer,
            [name]: e.target.value,
